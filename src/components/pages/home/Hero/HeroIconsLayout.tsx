...
const HeroIconsLayout = () => {
    const icons: IIconData[] = [
        ...
        { text: "AI/ML", position: { top: "80%", right: "35%" } },
        { text: "Psychology", position: { top: "85%", left: "25%" } },
        { text: "Finance", position: { top: "85%", right: "28%" } },
        { text: "Humanities", position: { bottom: "8%", left: "15%" } },
        { text: "Supply Chain", position: { bottom: "8%", left: "35%" } },
