          ...
          <div className="footer-content">
            ...
            <div className="footer-left">
              ...
              <div className="footer-description">
                At Soul AI, quality comes first. Every applicant undergoes a screening assessment
                and a domain-specific assessment to ensure high standards.
              </div>
              ...
              <div className="footer-social">
                ...
                <div className="footer-made-with">Made with 🫶 by Meet and Kartika</div>
              </div>
            </div>
